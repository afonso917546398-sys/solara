...
const en = {
  ...
  about: {
    ...
    variables: [
      ...
      { name: "Feels-like temperature", weight: "25 pts", detail: "Scored on a beach-comfort curve, not “hotter is better”. Below 10°C it’s zero (no skin exposed) and climbs gently to 25°C. The 25–35°C band is where it counts: 30°C beats 25°C, 35°C beats 30°C. Above 35°C it flatlines — hotter is neither better nor worse. Superman is unaffected either way." },
    ],
...
const pt: typeof en = {
  ...
  about: {
    ...
    variables: [
      ...
      { name: "Sensação térmica", weight: "25 pts", detail: "Pontuado por uma curva de conforto balnear, não “quanto mais quente, melhor”. Abaixo de 10 °C vale zero (sem pele exposta) e sobe suavemente até aos 25 °C. A faixa dos 25–35 °C é a que conta: 30 °C é melhor que 25 °C, 35 °C é melhor que 30 °C. Acima de 35 °C estabiliza — mais calor não é melhor nem pior. O Super-Homem não é afetado de qualquer forma." },
    ],
