...
const en = {
  ...
  about: {
    ...
    variables: [
      ...
      { name: "Feels-like temperature", weight: "25 pts", detail: "Scored on a beach-comfort curve, not “hotter is better”. Below 10°C it’s zero (no skin exposed) and climbs gently to 25°C. The 25–30°C band is where it counts: every degree from 25 to 30 adds sharply, and 30°C hits full marks. Above 30°C it flatlines — hotter is neither better nor worse. Superman is unaffected either way." },
    ],
...
const pt: typeof en = {
  ...
  about: {
    ...
    variables: [
      ...
      { name: "Sensação térmica", weight: "25 pts", detail: "Pontuado por uma curva de conforto balnear, não “quanto mais quente, melhor”. Abaixo de 10 °C vale zero (sem pele exposta) e sobe suavemente até aos 25 °C. A faixa dos 25–30 °C é a que conta: cada grau dos 25 aos 30 soma fortemente, e aos 30 °C atinge o máximo. Acima de 30 °C estabiliza — mais calor não é melhor nem pior. O Super-Homem não é afetado de qualquer forma." },
    ],
